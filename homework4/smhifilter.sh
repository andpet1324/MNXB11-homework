...
# Select only measurements done in 2019
FILTER_FILTERFILENAME_ONLY2019="2019_$FILTER_FILTEREDFILENAME"
log "Filtering on only measurements taken in 2019, writing to $CLEANER_FILTERFILENAME_ONLY2019"
grep '2019-' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLY2019
